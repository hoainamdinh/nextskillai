...
def create_skills_model(skills: list[str]) -> BaseModel:
    # Create a dictionary of fields with default values and types
    fields: Dict[str, tuple] = {skill.replace(" ", "_").replace("/", "_").replace("(", "").replace(")", "").replace("-", "_"): (int, ...) for skill in skills}
    # Dynamically create the model
    return create_model('SkillsModel', **fields)

# List of skills
skills_list = [
    'Python', 'SQL', 'Machine Learning', 'Deep Learning', 'Data Visualization', 'Statistics',
    'Big Data Tools (Spark, Hadoop)', 'ETL/Data Pipeline', 'Business Knowledge', 'Communication',
    'A/B Testing', 'Cloud Platforms (AWS, GCP, Azure)', 'Excel', 'Tableau/Power BI', 'NLP',
    'Computer Vision', 'Bioinformatics', 'Time Series Analysis', 'Data Cleaning',
    'Storytelling with Data', 'Problem Solving', 'Critical Thinking', 'Collaboration',
    'Project Management', 'Adaptability', 'A/B Testing', 'AI Tools', 'API Integration', 'Agile',
    'Bot Scripting', 'CRM Platforms', 'CRM Tools', 'CSS', 'Commission Tracking',
    'Community Management', 'Conflict Resolution', 'Conversion Rate Optimization', 'Copywriting',
    'Cost Optimization', 'Cross-functional Leadership', 'Customer Segmentation', 'Data Cleaning',
    'E-Commerce Strategy', 'Email Marketing', 'Encryption Techniques', 'Engagement Metrics',
    'Excel', 'Firewalls', 'Forecasting', 'Fraud Detection', 'Google Analytics', 'HTML',
    'Influencer Outreach', 'Inventory Management', 'Java/Kotlin', 'JavaScript', 'KPI Tracking',
    'Lifecycle Campaigns', 'Market Entry Planning', 'Market Research', 'Messenger Platform Integration',
    'NLP', 'Network Security', 'Order Processing', 'PCI Compliance', 'Partner Management',
    'Payment Gateways', 'Penetration Testing', 'Performance Analytics', 'Platform Selection',
    'Platform Strategy', 'Power BI', 'Problem Solving', 'Process Mapping', 'Product Categorization',
    'Project Management', 'Prototyping', 'ROI Analysis', 'Reporting Tools', 'Requirement Gathering',
    'Responsive Design', 'Roadmap Planning', 'SEM', 'SEO', 'SEO Content Writing', 'SQL', 'SSL',
    'SWOT Analysis', 'Scrum', 'Shipment Tracking', 'Stakeholder Communication', 'Statistical Analysis',
    'Storytelling', 'Strategic Planning', 'Supply Chain Software', 'Swift', 'Trend Analysis',
    'UX for Mobile', 'Usability Testing', 'User Research', 'Video Editing', 'Visual Merchandising',
    'Warehouse Operations', 'Web Performance Optimization', 'Wireframing', 'Communication', 'Teamwork',
    'Critical Thinking', 'Adaptability', 'Time Management', 'Creativity', 'Leadership',
    'Attention to Detail', 'Customer Focus'
]

# Create the model dynamically
# SkillsModel = create_skills_model(skills_list)
...
# skills_instance = SkillsModel(**example_data)
# print(skills_instance)
